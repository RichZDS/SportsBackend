...
import com.zds.sports.logic.EquipmentLogic;
...
public class EquipmentController {
    ...
    public PageResultVO<EquipmentVO> getEquipment(
        ...
        return equipmentLogic.getEquipment(page, size, keyword);
    }
    ...
    public EquipmentVO createEquipment(@Valid @RequestBody CreateEquipmentDTO createEquipmentDTO) {
        return equipmentLogic.createEquipment(createEquipmentDTO);
    }
    ...
    public EquipmentVO updateEquipment(
        ...
        return equipmentLogic.updateEquipment(id, updateEquipmentDTO);
    }
    ...
    public void deleteEquipment(@PathVariable Long id) {
        equipmentLogic.deleteEquipment(id);
    }
}
